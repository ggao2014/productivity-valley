...
> 状态：已批准 v0.3  
> 风格关键词：绘本画风 · 小人角色 · 乙游养成 · 简单易用 · 任务驱动的家园经营  
> 平台：Web 先行，验证后向跨端迁移
...
**已定：小人绘本风**（圆脸、略夸张头身比、友善剪影）。

MVP 可攻略角色（≥6，全员可走友情 + 爱情线）：

| id | 名字 | 气质旁白 | 喜好礼物倾向 |
|----|------|----------|--------------|
| `milo` | 米洛 | 总把背包放在门口的旅人 | 地图小笺、干粮点心 |
| `nana` | 娜娜 | 会给窗台浇花的邻居 | 种子袋、暖茶 |
| `pip` | 皮普 | 安静画小人的画家 | 颜料饼、素描本 |
| `rio` | 里奥 | 天不亮就去散步的早起客 | 围巾、热可可 |
| `ume` | 小梅 | 爱在厨房帮忙却常打翻面粉 | 食谱卡、甜饼干 |
| `toby` | 托比 | 带一盏小灯来借住的夜读人 | 书签、蜡烛 |
...
|--|-----|-----|
| 角色 | 6 人全可攻略 | 扩池、节日皮肤 |
| 剧情 | 每阶段 2–4 句旁白 + 姿态变化 | 多分支 CG / 长篇约会 |
| 开线 | 手动「心意选择」 | 角色专属条件开线 |
| 同居 | 邀请 + 小屋互动 | 伴侣间群像小事件 |
