...
|----|------|-------------------|-----------------|----------|----------|
| `shendu` | 沈渡 | 老摆渡人的孙子，近年替年迈爷爷摆渡；话少，事做完再说 | 竹篙、短蓑衣 | 寡言 | 热姜汤 |
| `qinghe` | 青禾 | 租田种粮、也卖粮种；风风火火，爱指挥，跟老张头结着梁子 | 稻穗发饰、泥点裤脚、种袋 | 风风火火、爱指挥 | 麦香饼 |
| `guwan` | 顾晚 | 替人量田画图；尖锐好胜，常被扯皮夹在中间就溜 | 油纸伞、标尺、墨线 | 尖锐、好胜 | 糖炒栗子 |
| `linchu` | 林初 | 木匠；较真憨直，话少，差一点就重做 | 刨花、凿子、边角料 | 较真，憨直 | 小木块 |
| `jiangxiaoman` | 姜小满 | 办席掌勺、也爱腌菜；热闹爱操心，忙起来连口水都顾不上 | 面粉手印、围裙、调料罐 | 热闹、爱操心 | 桂花糖 |
| `baizhi` | 白芷 | 采药晒药、收集标本；轻盈好奇，认药不看病 | 药篓、标本、百草茶 | 轻盈、好奇 | 蜜橘皮 |
| `chenshi` | 陈拾 | 货郎，啥都倒腾；油滑会来事，嘴停不住 | 钱袋、补丁马褂、账本 | 油滑、会来事 | 小玩意 |
| `suweiming` | 苏未名 | 代写书信、也爱写故事；戏多的古风小生，考不中便写信渡日 | 毛笔、稿箱、印泥 | 戏多的古风小生 | 印泥 |
| `yueqingshan` | 岳青衫 | 巡山护路、教防身；板正好面子，怕雷死不承认 | 青布劲衣、木剑、木哨 | 板正、好面子 | 暖手豆袋 |
| `taotao` | 桃桃 | 走村赶集的糖画匠；要强爱嚷，想攒钱换带阳棚的大车 | 旧铜勺、折叠小车 | 爽快、要强 | 小木块、莲纸 |
| `wenjiu` | 温九 | 镇上账房先生；爱管人、冷面吐槽，记性好反而不敢忘 | 钥匙、账本、茶饼 | 爱管人、冷面吐槽 | 茶饼 |
| `hedeng` | 河灯 | 灯匠；做纸灯路灯，舍不得丢练手半成品 | 小灯、油壶、歪头鹅 | 跳脱、凭感觉办事 | 莲纸 |
